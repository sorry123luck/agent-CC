...
// Filter out icon names that shadow JavaScript globals or React exports.
const RESERVED_IMPORTS = new Set([
  'Map', 'Set', 'WeakMap', 'WeakSet', 'Symbol', 'Promise', 'Error', 'Date', 'RegExp',
  'Activity',
]);
const usedLucideIcons = getUsedLucideIcons().filter((name) => !RESERVED_IMPORTS.has(name));
